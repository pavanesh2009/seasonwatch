<?php 	session_start();	$page_title="SeasonWatch: Participants";    include("main_includes.php");
?>
<body>
<?
       include("header.php");
...
$sql = "SELECT state FROM seswatch_states";
 ...
 */
$sql = "SELECT u.user_name, u.user_id, u.city, st.state, st.state_id FROM users u " .
	   " LEFT JOIN seswatch_states st ON u.state_id = st.state_id" .
