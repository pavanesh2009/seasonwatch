...
function get_recent_news() {
        $wordpress_db=mysql_select_db("wp",$link );
...
function return_thumbnail($picname) {
$th_picname=substr($picname,0,strlen($picname)-4)."_th".substr($picname,strlen($picname)-4,4);
